            ...
            <form>
                <div class="insurance_carrier">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="number" class="form-control" id="passport_number">
                    </div>
                ...
                <div class="additional_insured_wrapper">
                    <div class="d-flex justify-content-between">
                        <h4 class="mt-3">Dodatna lica na polisi</h4>
                        <button type="button" class="btn btn-outline-success btn-sm self-right my-3">Dodavanje dodatnih
                            osiguranika</button>
                    </div>

                    <div class="additional_insured row p-2">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mt-3">
                                ...
                                <input type="number" class="form-control" id="passport_number_0">
                            </div>
                        </div>
                    </div>
                </div>
